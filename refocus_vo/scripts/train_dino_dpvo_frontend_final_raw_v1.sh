...
export DINO_DPVO_CONFIG="${DINO_DPVO_CONFIG:-$SUBTREE_ROOT/configs/dino_dpvo_final_frontend_raw_v1.yaml}"
export DPVO_CONFIG_PATH="${DPVO_CONFIG_PATH:-$SUBTREE_ROOT/external/repos/DPVO/config/default.yaml}"
export TRAIN_RUN_ID="${TRAIN_RUN_ID:-dino_dpvo_final_frontend_raw_v1}"
export INIT_CHECKPOINT="${INIT_CHECKPOINT:-$SUBTREE_ROOT/runs/train/dino_dpvo_frontend_geom_pretrain_v2/best.pt}"
