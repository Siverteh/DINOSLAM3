...
try:
    ...
    SemanticMappingConfigs = None
    evaluate_semantic_mapping = None
...
try:
    ...
    DepthEstimatorType = None
    img_from_depth = None
    filter_shadow_points = None
...
if __name__ == "__main__":
    ...
    if Parameters.kDoSparseSemanticMappingAndSegmentation and SemanticMappingConfigs is not None:
        semantic_mapping_config = SemanticMappingConfigs.get_config_from_slam_dataset(
    ...
    if (
        ...
        # Keep DINOSLAM3 internal detector count in sync with the generic feature count override.
        if "dinoslam3_num_features" in feature_tracker_config:
            feature_tracker_config["dinoslam3_num_features"] = config.num_features_to_extract
    if (
    ...
    if (
        ...
        if SemanticMappingConfigs is not None:
            ...
            Printer.orange("Semantic mapping config requested, but semantics modules are unavailable.")
    ...
    if Parameters.kDoSparseSemanticMappingAndSegmentation and semantic_mapping_config is not None:
        Printer.green(
    ...
    if Parameters.kUseDepthEstimatorInFrontEnd and depth_estimator_factory is not None:
    ...
    elif Parameters.kUseDepthEstimatorInFrontEnd:
        Printer.orange("Depth estimator requested but depth_estimation modules are unavailable.")
    ...
    try:
        ...
        if evaluate_semantic_mapping is not None:
