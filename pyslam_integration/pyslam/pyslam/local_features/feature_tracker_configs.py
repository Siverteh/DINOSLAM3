...
class FeatureTrackerConfigs:
    ...
    DINOSLAM3 = dict(
        ...
        num_levels=1,
        scale_factor=1.2,
        detector_type=FeatureDetectorTypes.DINOSLAM3,
        descriptor_type=FeatureDescriptorTypes.DINOSLAM3,
        sigma_level0=Parameters.kSigmaLevel0,
        match_ratio_test=0.8,
        tracker_type=kTrackerType,
        dinoslam3_checkpoint=None,
        dinoslam3_device="cuda",
        dinoslam3_num_features=kNumFeatures,
        dinoslam3_normalize_descriptors=True,
    )
