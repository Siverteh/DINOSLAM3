...
class FeatureDetectorTypes(SerializableEnum):
    ...
    KEYNETAFFNETHARDNET = 28
    DINOSLAM3 = 29  # [end-to-end] DINOSLAM3 joint detector-descriptor
    # [kornia-based] Convenience module, which implements KeyNet detector + AffNet + HardNet descriptor. "Key.Net: Keypoint Detection by Handcrafted and Learned CNN Filters"
...
class FeatureDescriptorTypes(SerializableEnum):
    ...
    KEYNETAFFNETHARDNET = 33
    DINOSLAM3 = 34  # [end-to-end] DINOSLAM3 joint detector-descriptor
    # [kornia-based] Convenience module, which implements KeyNet detector + AffNet + HardNet descriptor. "Key.Net: Keypoint Detection by Handcrafted and Learned CNN Filters"
...
class FeatureInfo(object):
    ...
    #
    norm_type[FeatureDescriptorTypes.DINOSLAM3] = cv2.NORM_L2
    max_descriptor_distance[FeatureDescriptorTypes.DINOSLAM3] = 2.0  # DINOSLAM3
    #
