...
if(EXISTS "${OUR_CMAKE_DIR}/CMakeCache.txt")
  # In build tree
  set(GTSAM_UNSTABLE_INCLUDE_DIR /workspace/pyslam_integration/pyslam/thirdparty/gtsam_local CACHE PATH "GTSAM_UNSTABLE include directory")
else()
...
find_package(Boost 1.65 COMPONENTS serialization;filesystem;thread;program_options;date_time;timer;chrono;regex)
else()
find_dependency(Boost 1.65 COMPONENTS serialization;filesystem;thread;program_options;date_time;timer;chrono;regex)
endif()
